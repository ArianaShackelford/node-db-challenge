...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
    ...
    Relational Databases are the tables that make up the database and SQL is the standard api used with ralational databasi . :P 

- [ ] Why do tables need a `primary key`?

  Every row in a table needs a unique identifier so that it can always be accessed reliably
